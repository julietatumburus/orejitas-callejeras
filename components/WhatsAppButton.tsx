...
/** Botón que abre WhatsApp con un mensaje pre-cargado sobre el perrito. */
export default function WhatsAppButton({ dogName }: { dogName: string }) {
  return (
    <a
      href={whatsappLink(dogName)}
      target="_blank"
