...
export default async function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-pink-200 bg-gradient-to-b from-pink-50 to-pink-100/70">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 px-4 py-12 text-center">
        <p className="flex items-center gap-2 text-lg font-bold text-pink-700">
