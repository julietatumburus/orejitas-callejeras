    ...
    <>
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-10">
        <header className="mb-8 text-center">
          <h1 className="text-3xl font-extrabold text-pink-600">En adopción 🐾</h1>
          <p className="mt-2 text-stone-600">
            Filtrá por tipo, tamaño y sexo. Tocá <span className="font-semibold">Quiero saber más</span>{" "}
