  ...
  return (
    <main className="flex flex-1 items-center justify-center px-4 py-16">
      ...
      <div className="w-full max-w-sm rounded-2xl border border-pink-200 bg-white p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Link
              ...
              className="mt-1 self-end text-xs font-medium text-pink-600 hover:underline"
            >
        ...
        <Link href="/" className="mt-6 block text-center text-sm text-stone-400 hover:text-pink-600">
          ← Volver al inicio
        </Link>
      </div>
    </main>
